var rule = {
    ...
    一级: $js.toString(() => {
        ...
        list.forEach(it => {
            ...
            d.push({
                url: id,
                title: it.name,
                img: 'https://gh-proxy.com/https://raw.githubusercontent.com/lqxcn/panghu/main/img/戏曲.jpg',
                desc: it.des,
            })
        })
        setResult(d);
    ...
    二级: $js.toString(() => {
        ...
        VOD = {
            vod_pic: 'https://gh-proxy.com/https://raw.githubusercontent.com/lqxcn/panghu/main/img/戏曲.jpg',
            vod_play_from: '多多专线',
