...
class Spider(Spider):
    ...
    # 📂 【配置区】
    # ==========================================================================
    PY_DIR    = "/storage/emulated/0/本地包/panghu18/py"
    JS_DIR    = "/storage/emulated/0/本地包/panghu18/js"
    JAR_DIR   = "/storage/emulated/0/本地包/panghu18/jar"
    SAVE_PATH = "/storage/emulated/0/本地包/panghu18/智能18接口.json"
    LOGO_PATH = "/https://ghfast.top/https://raw.githubusercontent.com/lqxcn/panghu/main/img/panghu.jpg"
    ...
    _LOCKED_SITES = [
		{
            ...
            "key": "自动加载",
            "type": 3,
            "api": "https://ghfast.top/https://raw.githubusercontent.com/lqxcn/panghu/main/lib/智能加载18v5.1.py"
         },
		{
            "name": "弹幕",
            "key": "弹幕豆瓣",
