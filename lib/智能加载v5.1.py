...
class Spider(Spider):
    ...
    # 📂 【配置区】
    # ==========================================================================
    PY_DIR    = "/storage/emulated/0/本地包/panghu/py"
    JS_DIR    = "/storage/emulated/0/本地包/panghu/js"
    JAR_DIR   = "/storage/emulated/0/本地包/panghu/jar"
    SAVE_PATH = "/storage/emulated/0/本地包/panghu/智能接口.json"
    ...
    _LOCKED_SITES = [
		{
            ...
            "key": "自动加载",
            "type": 3,
            "api": "https://ghfast.top/https://raw.githubusercontent.com/lqxcn/panghu/main/lib/智能加载v5.1.py"
         },
		{
            "name": "弹幕",
            "key": "弹幕豆瓣",
